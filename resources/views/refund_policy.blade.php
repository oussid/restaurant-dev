...
@section('content')
<x-navbar></x-navbar>
<x-banner><h1>Refund <span>policy</span></h1></x-banner>
<div class="privacy-container">
    <div class="privacy-policy-container">
        <div class="document-previewer-wrapper-a717db"><style>[data-custom-class='body'],[data-custom-class='body'] *{background: transparent !important;
